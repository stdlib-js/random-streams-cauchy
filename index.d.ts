...
/**
* Class for creating readable streams which generate a stream of pseudorandom numbers drawn from a Cauchy distribution.
*/
declare class RandomStream extends Readable {
	...
	*/
	constructor( x0: number, gamma: number, options?: Options );
...
interface Constructor {
	...
	* stream.pipe( inspectStream( log )  );
	*/
	new( x0: number, gamma: number, options?: Options ): RandomStream; // newable
	...
	* stream.pipe( inspectStream( log )  );
	*/
	( x0: number, gamma: number, options?: Options ): RandomStream; // callable
	...
	*/
	objectMode( x0: number, gamma: number, options?: Options ): RandomStream;
}
