...
```javascript
randomStream = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/random-streams-cauchy@umd/browser.js' )
```
The previous example will load the latest bundled code from the umd branch. Alternatively, you may load a specific version by loading the file from one of the [tagged bundles](https://github.com/stdlib-js/random-streams-cauchy/tags). For example,

```javascript
randomStream = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/random-streams-cauchy@v0.2.2-umd/browser.js' )
```

To vendor stdlib functionality and avoid installing dependency trees for Node.js, you can use the UMD server build:

```javascript
var randomStream = require( 'path/to/vendor/umd/random-streams-cauchy/index.js' )
```

To include the bundle in a webpage,

```html
<script type="text/javascript" src="https://cdn.jsdelivr.net/gh/stdlib-js/random-streams-cauchy@umd/browser.js"></script>
```
...
[npm-image]: http://img.shields.io/npm/v/@stdlib/random-streams-cauchy.svg
[npm-url]: https://npmjs.org/package/@stdlib/random-streams-cauchy

[test-image]: https://github.com/stdlib-js/random-streams-cauchy/actions/workflows/test.yml/badge.svg?branch=v0.2.2
[test-url]: https://github.com/stdlib-js/random-streams-cauchy/actions/workflows/test.yml?query=branch:v0.2.2

[coverage-image]: https://img.shields.io/codecov/c/github/stdlib-js/random-streams-cauchy/main.svg
[coverage-url]: https://codecov.io/github/stdlib-js/random-streams-cauchy?branch=main

<!--

[dependencies-image]: https://img.shields.io/david/stdlib-js/random-streams-cauchy.svg
[dependencies-url]: https://david-dm.org/stdlib-js/random-streams-cauchy/main
...
[cli-section]: https://github.com/stdlib-js/random-streams-cauchy#cli
[cli-url]: https://github.com/stdlib-js/random-streams-cauchy/tree/cli
[@stdlib/random-streams-cauchy]: https://github.com/stdlib-js/random-streams-cauchy/tree/main

[umd]: https://github.com/umdjs/umd
[es-module]: https://developer.mozilla.org/en-US/docs/Web/JavaScript/Guide/Modules

[deno-url]: https://github.com/stdlib-js/random-streams-cauchy/tree/deno
[deno-readme]: https://github.com/stdlib-js/random-streams-cauchy/blob/deno/README.md
[umd-url]: https://github.com/stdlib-js/random-streams-cauchy/tree/umd
[umd-readme]: https://github.com/stdlib-js/random-streams-cauchy/blob/umd/README.md
[esm-url]: https://github.com/stdlib-js/random-streams-cauchy/tree/esm
[esm-readme]: https://github.com/stdlib-js/random-streams-cauchy/blob/esm/README.md
[branches-url]: https://github.com/stdlib-js/random-streams-cauchy/blob/main/branches.md

[stdlib-license]: https://raw.githubusercontent.com/stdlib-js/random-streams-cauchy/main/LICENSE
